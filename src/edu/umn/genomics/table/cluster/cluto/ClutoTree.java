/*
 * @(#) $RCSfile: ClutoTree.java,v $ $Revision: 1.1 $ $Date: 2003/07/28 19:30:21 $ $Name: TableView1_2 $
 *
...
/**
 * ClutoTree displays a hierarchical clustering of rows from a table.
 ...
 * @author       J Johnson
 * @version $Revision: 1.1 $ $Date: 2003/07/28 19:30:21 $  $Name: TableView1_2 $ 
 * @since        1.0
 * @see  ColumnMap
 * @see  TableContext
 ...
 */
public class ClutoTree extends JPanel
             implements CleanUp, Serializable {
  JToolBar btnP = null;
  ...
  /**
   * Constructs a ClutoTree diaplay which is initialized with
  ...
  /**
   * Traververse the tree selecting rows coresponding to leaf nodes of 
   * the given node tn
