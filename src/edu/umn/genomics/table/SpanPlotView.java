/*
 * @(#) $RCSfile: SpanPlotView.java,v $ $Revision: 1.1 $ $Date: 2004/08/02 20:23:46 $ $Name: TableView1_3 $
 *
...
/**
 * SpanPlotView displays a scatter plot of the two selected columns
 * of the table.
 * @author       J Johnson
 ...
 */
public class SpanPlotView extends AbstractTableModelView
  ...
  private void setColumns() {
    if (ctx != null && plotPanel != null) {
      try {
        ...
        ColumnMap sMap = ctx.getColumnMap(tm,sChoice.getSelectedIndex());  
