/*
 * @(#) $RCSfile: DataView.java,v $ $Revision: 1.10 $ $Date: 2003/05/15 18:23:43 $ $Name: TableView1_2 $
 *
...
/**
 * @author       J Johnson
 * @version $Revision: 1.10 $ $Date: 2003/05/15 18:23:43 $  $Name: TableView1_2 $
 * @since        1.0
 */
public class DataView extends JPanel implements Serializable, Observer {
  ...
  if (false) { // start of new menulook
    ...
    */
    ...
    mi = (JMenuItem)properties.add(new JCheckBoxMenuItem("Show Axes",true));
    ...
    mi = (JMenuItem)properties.add(new JCheckBoxMenuItem("Inertia",inertia));
    mi.addItemListener(new ItemListener() {
          public void itemStateChanged(ItemEvent e) {
