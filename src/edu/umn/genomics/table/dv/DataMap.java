/*
 * @(#) $RCSfile: DataMap.java,v $ $Revision: 1.14 $ $Date: 2003/07/28 15:07:19 $ $Name: TableView1_2 $
 *
 ...
 * @version $Revision: 1.14 $ $Date: 2003/07/28 15:07:19 $  $Name: TableView1_2 $ 
 * @since dv1.0
 */
public class DataMap extends Observable 
  ...
  public void openMapPanel() {
    ...
    for (int i = 0; i < columnCnt; i++) {
      mi = (JMenuItem)xMenu.add( new JRadioButtonMenuItem(columnNames[i],i==0));
    ...
    for (int i = 0; i < columnCnt; i++) {
      mi = (JMenuItem)yMenu.add( new JRadioButtonMenuItem(columnNames[i],i==1));
      mi.setActionCommand("" + i);
      yBG.add(mi);
    ...
    for (int i = 0; i < columnCnt; i++) {
      mi = (JMenuItem)zMenu.add( new JRadioButtonMenuItem(columnNames[i],i==2));
      mi.setActionCommand("" + i);
      zBG.add(mi);
