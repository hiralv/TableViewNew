/*
 * @(#) $RCSfile: Glyph3D.java,v $ $Revision: 1.1 $ $Date: 2003/05/15 18:23:49 $ $Name: TableView1_2 $
 *
...
public class Glyph3D extends BranchGroup implements Serializable,Glyph {
  ...
  Glyph3D(Primitive primitive) {
    initGlyph3D();
    setPrimitive(primitive);
  }

  Glyph3D(String glyphType) {
    initGlyph3D();
  ...
  private void initGlyph3D() {
    ...
    rep.setCapability(Switch.ALLOW_CHILDREN_READ);
    rep.setCapability(Switch.ALLOW_CHILDREN_WRITE);
    rep.setCapability(Switch.ALLOW_CHILDREN_EXTEND);
  ...
  public void setPrimitive(String primName) {
    ...
    case 0:  // sphere
      ...
      break;
    case 1:  // cube
      prim = new Box(radius,radius,radius,
      Primitive.GENERATE_NORMALS|
      Primitive.ENABLE_APPEARANCE_MODIFY|
      Primitive.ENABLE_GEOMETRY_PICKING,
      appearance);
      break;
    case 2:  // cylynder
      prim = new Cylinder(radius, 2 * height,
      Primitive.GENERATE_NORMALS|
      Primitive.ENABLE_APPEARANCE_MODIFY|
      Primitive.ENABLE_GEOMETRY_PICKING,
      appearance);
  ...
  public void setPrimitive(Primitive primitive) {
    if (primitive != null) {
      ...
      primitive.setCapability(Primitive.ENABLE_APPEARANCE_MODIFY|Primitive.ENABLE_GEOMETRY_PICKING);
