/*
 * @(#) $RCSfile: JTableEditor.java,v $ $Revision: 1.1 $ $Date: 2004/08/02 20:23:42 $ $Name: TableView1_3 $
 *
 ...
 *
 * @author       J Johnson
 * @version $Revision: 1.1 $ $Date: 2004/08/02 20:23:42 $  $Name: TableView1_3 $ 
 * @since        1.0
...
public class JTableEditor extends AbstractTableSource {
  ...
  /**
   * Display a JTableEditor
   * usage: java edu.umn.genomics.table.JTableEditor 
   * @see FileTableModel
   */
