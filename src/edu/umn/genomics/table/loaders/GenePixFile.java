/*
 * @(#) $RCSfile: GenePixFile.java,v $ $Revision: 1.3 $ $Date: 2003/12/12 17:53:31 $ $Name: TableView1_2 $
 *
 ...
 * The GenePix file should have the Axon Text File format:
 * 
 * <code>
 ...
 *
 * @author       J Johnson
 * @version $Revision: 1.3 $ $Date: 2003/12/12 17:53:31 $  $Name: TableView1_2 $ 
 * @since        1.0
...
public class GenePixFile extends AbstractTableSource implements OpenTableSource {
  ...
  String exts[] = {"gpr","gal"};
  javax.swing.filechooser.FileFilter gpFileFilter = new ExtensionFileFilter(Arrays.asList(exts), "*.gpr and *.gal files");
  ...
  public void openTableSource(String tableSource) throws IOException {
    ...
    LineNumberReader lnr = new LineNumberReader(OpenInputSource.getBufferedReader(tableSource));
    // Read the ID and version line
    String line = lnr.readLine();
    if (line == null || !line.startsWith("ATF")) {
      throw new IOException("Not in GenePix Axon Text Format: missing ATF field in first line");
    }
    sb.append(line).append(lineSep);
    // Read the header length and column number line
    line = lnr.readLine();
    if (line == null) {
      throw new IOException("Not in GenePix Axon Text Format: missing counts in second line");
    }
