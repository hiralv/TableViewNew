/*
 * @(#) $RCSfile: AboutDB.java,v $ $Revision: 1.1 $ $Date: 2003/07/28 16:36:18 $ $Name: TableView1_2 $
 *
 ...
 * @author       J Johnson
 * @version $Revision: 1.1 $ $Date: 2003/07/28 16:36:18 $  $Name: TableView1_2 $ 
 * @since        1.0
...
public class AboutDB {
   ...
   * @param dbmd the DatabaseMetaData for the Database
  ...
  /**
   * Return as a TableModel the method names and the values they return 
   * for methods that have boolean return values.
   * @param dbmd the DatabaseMetaData for the Database
  ...
  /**
   * Return as a TableModel the method names and the values they return 
   * for methods that have int return values and no input parameters.
   * @param dbmd the DatabaseMetaData for the Database
   * @return a TableModel of method names and returned values.
   */
  ...
  /**
   * Return as a TableModel the method names and the values they return 
   * for methods that have String return values and no input parameters.
   * @param dbmd the DatabaseMetaData for the Database
   * @return a TableModel of method names and returned values.
   */
  ...
  public static TableModel getSQLKeywords(DatabaseMetaData dbmd) {
    ...
    try {
      ...
      for(StringTokenizer st = new StringTokenizer(kw,","); st != null && st.hasMoreTokens(); ) {
        cols = new Vector(1);
  ...
  /**
   * Return as a TableModel the Function type: String, Numeric, or Date, 
  ...
  /**
   * Return as text the method names and the values they return 
   * for methods in the DatabaseMetaData interface that don't 
   ...
   * @param rs the table data for the TableModel
   * @return a TableModel of method names and returned values.
   */
  ...
  /**
   * Return a text representation of a data table, with Column Headings
   * from the ResultSetMetaData.  Fields are separated by the TAB character.
   * @param rs the table data for the TableModel
