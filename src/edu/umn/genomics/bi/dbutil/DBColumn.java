/*
 * @(#) $RCSfile: DBColumn.java,v $ $Revision: 1.2 $ $Date: 2003/08/08 17:54:52 $ $Name: TableView1_2 $
 *
 ...
 * @author       J Johnson
 * @version $Revision: 1.2 $ $Date: 2003/08/08 17:54:52 $  $Name: TableView1_2 $
 * @since        1.0
...
public class DBColumn {
   ...
   * @return a list of DBColumn instances for the given table.
   * @throws NullPointerException If either dbmd or table are null.
   * @throws SQLException from java.sql.DatabaseMetaData.getColumns method
   */
  ...
  /**
   * Return a DBColumn instance for the current row in the ResultSet returned from 
   * {@link java.sql.DatabaseMetaData#getColumns(String, String, String, String)}.
   * This is typically called by {@link #getDBColumn(DatabaseMetaData, DBTable)}.
   * @param table the table for which the column information was retrieved, if null 
   * a new DBTable instance will be created for this column.
   * @param rs the ResultSet of column information.
   * @return a DBColumn instance for this row in the ResultSet.
   * @throws SQLException from retrieving column data from the ResultSet
   */
  public static DBColumn getDBColumn(DBTable table, ResultSet rs) throws SQLException {
  ...
  public String getQualifiedName() {
    return (table != null ? table.getQualifiedName() + "." : "") + getColumnName();
  }
