/*
 * @(#) $RCSfile: DBUserPanel.java,v $ $Revision: 1.8 $ $Date: 2003/08/29 13:40:02 $ $Name: TableView1_2 $
 *
 ...
 * to a data base.
 * @author       J Johnson
 * @version $Revision: 1.8 $ $Date: 2003/08/29 13:40:02 $  $Name: TableView1_2 $ 
 * @since        1.0
 */
public class DBUserPanel implements DBConnectParams {
  ...
  /**
   * Construct a form for entering database connection parameters 
   * with all blank entry fields.
   */
  public DBUserPanel() {
    init();
  }
  ...
  /**
   * Construct a form for entering database connection parameters 
   * from an existing set of parameters.
   * @param params Database account connection parameters.
   */
   ...
   * @param comboBoxModel a ComboBoxModel containing a list of DBConnectParams.
   */
  ...
  private void init() {
    ...
    dbUsersLabel = new JLabel("Select Account: ", JLabel.RIGHT);
    // 
    dbNameLabel = new JLabel("Connection name: ", JLabel.RIGHT);
   ...
   * @param newdbuser the database connection parameters.
   */
